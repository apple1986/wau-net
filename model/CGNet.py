...
class CGNet(nn.Module):
    ...
    """
    def __init__(self, classes=2, M= 2, N= 5, dropout_flag = True):
        """
        args:
        ...
        """
        super().__init__()
        self.level1_0 = ConvBNPReLU(1, 32, 3, 2)      # feature map size divided 2, 1/2
        ...
        #stage 2
        self.level2_0 = ContextGuidedBlock_Down(32 +1, 64, dilation_rate=2,reduction=8)  
        ...
        #stage 3
        self.level3_0 = ContextGuidedBlock_Down(128 + 1, 128, dilation_rate=4, reduction=16) 
